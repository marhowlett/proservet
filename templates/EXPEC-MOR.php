  ...
  <section id="ficha" class="template-section">
        ...
        <div class="contenedor">
            <div class="grid">
                ...
                <div class="formula">
                <h2>COMPOSICIÓN</h2>
                <p>Cada 100 g. de <strong>EXPEC-MOR</strong> contiene: <br>
...
Excipiente C.B.P........................100g.</p>
                ...
                <p><strong>EXPEC-MOR</strong> se usa como auxiliar en el tratamiento de afecciones del tracto
respiratorio, expectorante, tónico cardiaco y broncodilatador.</p>
               <hr>
                <h2>ADMINISTRACIÓN Y DOSIS</h2>
                <p>Aves (Engorda y reproductoras), porcinos, caninos, felinos y bovinos
(becerros). 1 g. por cada 10 litros de agua de bebida durante 3 a 10 días.</p>
              <p>Administración oral en agua de bebida.</p>
               <hr>
